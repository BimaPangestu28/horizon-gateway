...
export default function RouteCreate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Simulate a successful response with a new ID
    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-center">
          <Link to="/routes" className="mr-4 text-gray-500 hover:text-gray-700">
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Higher values indicate higher priority when multiple routes
                  match.
                </p>
              </div>
              ...
              <div className="sm:col-span-6">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  The path pattern to match incoming requests. Use * for
                  wildcards.
                </p>
              </div>
                  ...
                  <div className="mt-2 space-y-4">
                    <div className="flex items-center">
                      <input
                        ...
                        checked={
                          formValues.methods.length === HTTP_METHODS.length
                        }
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      If enabled, the matched URL prefix will be removed before
                ...
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  <div className="sm:col-span-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleNestedChange('rate_limit', 'type', e.target.value)
                      }
                      className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    >
          ...
          <div className="pt-8">
            ...
            <div className="mt-6">
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    htmlFor="circuit_breaker_enabled"
                    className="font-medium text-gray-700"
                  >
                    Enable Circuit Breaker
                  </label>
                  <p className="text-gray-500">
                    Automatically stop forwarding requests when the upstream
                    service is failing.
                  </p>
                </div>
              </div>
              ...
              {formValues.circuit_breaker_enabled && (
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-2">
                    <label
                      htmlFor="circuit_breaker_error_threshold"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Error Threshold (%)
                    </label>
                  ...
                  <div className="sm:col-span-2">
                    <label
                      htmlFor="circuit_breaker_min_requests"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Minimum Requests
                    </label>
                  ...
                  <div className="sm:col-span-2">
                    <label
                      htmlFor="circuit_breaker_window"
                      className="block text-sm font-medium text-gray-700"
                    >
                      Window
                    </label>
                ...
                <div className="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  <div className="sm:col-span-3">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleNestedChange('cache', 'type', e.target.value)
                      }
                      className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    >
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        onChange={(e) =>
                          handleNestedChange('cache', 'ttl', e.target.value)
                        }
